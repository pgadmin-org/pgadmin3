...
"%ProgramFiles%\HTML Help Workshop\hhc.exe" ./en_US/_build/htmlhelp/pgAdminIIIdoc.hhp
...
"%WXWIN%\utils\hhp2cached\vc_mswu\hhp2cached.exe" ./en_US/_build/htmlhelp/pgAdminIIIdoc.hhp
