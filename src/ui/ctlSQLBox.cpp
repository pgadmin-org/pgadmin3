...
#define SQL_KEYWORDS wxT("\
        ...
        OIDS ON OPERATOR OPTION OR ORDER OUTER PREPARE PRIMARY PROCEDURE REINDEX REFERENCES REPLACE RESET RETURN RETURNS REVOKE ROLLBACK ROW RULE \
        SCHEMA SELECT SET SEQUENCE SESSION SHOW STABLE STATEMENT STRICT TABLE THEN TO TRIGGER TRUNCATE TYPE \
