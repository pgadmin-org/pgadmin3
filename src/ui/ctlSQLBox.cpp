...
#define SQL_KEYWORDS wxT("\
        ...
        DATABASE DEALLOCATE DECLARE DEFAULT DELETE DESC DESCENDING DOMAIN DROP EACH ELSE END EXPLAIN \
        FETCH FOR FOREIGN FREEZE FROM FULL FUNCTION GRANT GROUP \
        HAVING ILIKE IMMUTABLE IN INDEX INNER INSERT INTO IS JOIN KEY LANGUAGE LIKE LISTEN LOAD LOCK MOVE NOT NOTIFY NULL \
