...
#
BuildRequires: autoconf >= 2.57, automake >= 1.7.2, gtk2-devel >= 2.2, gtk+-devel >= 1.2, gtk+ >= 1.2, postgresql >= 7.3.2, openssl-devel >= 0.9.6, pkgconfig >= 0.14, libpng-devel >= 1.2.2, gcc-c++ >= 3.2
