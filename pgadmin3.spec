...
Requires: gtk2 >= 2.2, glibc >= 2.3.2, libjpeg >= 6, libpng >= 1.2.2, pango >= 1.2.1, libstdc++ >= 3.2.2, openssl >= 0.9.6, libtiff >= 3.5.7, zlib >= 1.1.4, glib2 >= 2.2.1, postgresql-libs >= 7.3.2, atk >= 1.2, freetype >= 2.1
...
#
BuildRequires: autoconf >= 2.57, automake >= 1.7.2, gtk2-devel >= 2.2, gtk+-devel >= 1.2, gtk+ >= 1.2, postgresql >= 7.3.2, openssl-devel >= 0.9.6, pkgconfig >= 0.14, libpng-devel >= 1.2.2, gcc-c++ >= 3.2, atk-devel >= 1.2, pango-devel >= 1.2.1, freetype-devel >= 2.1
