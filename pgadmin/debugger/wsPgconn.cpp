...
// RCS-ID:      $Id: wsPgconn.cpp 6213 2007-04-19 08:47:08Z dpage $
...
wsPgConn::wsPgConn(wsMainFrame *frame, const wxString &server, const wxString &database, const wxString &userName, const wxString &password, const wxString &port, int sslmode )
   : m_frame(frame)
{
	Init( server, database, userName, password, port, sslmode, true );
}

wsPgConn::wsPgConn(wsMainFrame *frame, const wsConnProp & props, bool startThread )
   : m_frame(frame)
{
