...
void dbgPgThread::startCommand( const wxString &command, wxEvtHandler * caller, wxEventType eventType )
{
	...
	m_queueMutex.Lock();
	m_commandQueue.Append( new dbgPgThreadCommand( command, caller, eventType ));
