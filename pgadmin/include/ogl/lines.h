...
public:
	...
	inline void SetXOffset(double x)
	{
		m_xOffset = x;
	}
	inline void SetYOffset(double y)
	{
		m_yOffset = y;
	}
	inline wxPseudoMetaFile *GetMetaFile() const
	{
		return m_metaFile;
	}
	...
	inline int GetArrowEnd() const
	{
		return m_arrowEnd;
	}
	inline double GetArrowSize() const
	{
		return m_arrowSize;
	}
	void SetSize(double size);
	inline void SetSpacing(double sp)
	{
		m_spacing = sp;
	}
...
public:
	...
	virtual bool OnMoveControlPoint(int WXUNUSED(which), double WXUNUSED(x), double WXUNUSED(y))
	{
		return FALSE;
	}
	virtual bool OnMoveMiddleControlPoint(wxLineControlPoint *lpt, const wxRealPoint &pt);
	virtual bool OnLabelMovePre(wxLabelShape *labelShape, double x, double y, double old_x, double old_y, bool display);
	...
	inline virtual wxShape *GetFrom()
	{
		return m_from;
	}
	inline virtual wxShape *GetTo()
	{
		return m_to;
	}
	inline virtual int GetAttachmentFrom()
	{
		return m_attachmentFrom;
	}
	inline virtual int GetAttachmentTo()
	{
		return m_attachmentTo;
	}
	...
	// Not implemented
	inline void SetMaintainStraightLines(bool flag)
	{
		m_maintainStraightLines = flag;
	}
	inline bool GetMaintainStraightLines() const
	{
		return m_maintainStraightLines;
	}
	...
	virtual wxNode *InsertLineControlPoint();
	virtual bool DeleteLineControlPoint();
	virtual void Initialise();
	inline wxList *GetLineControlPoints()
	{
		return m_lineControlPoints;
	}
	...
	inline void SetSpline(bool spl)
	{
		m_isSpline = spl;
	}
	inline bool IsSpline() const
	{
		return m_isSpline;
	}
	...
	inline void SetAttachmentFrom(int attach)
	{
		m_attachmentFrom = attach;
	}
	inline void SetAttachmentTo(int attach)
	{
		m_attachmentTo = attach;
	}
	...
	inline void SetIgnoreOffsets(bool ignore)
	{
		m_ignoreArrowOffsets = ignore;
	}
	inline wxList &GetArrows() const
	{
		return (wxList &) m_arcArrows;
	}
	...
	{
		return m_alignmentStart;
	}
	int GetAlignmentEnd() const
	{
		return m_alignmentEnd;
	}
	void SetAlignmentStart(int alignStart)
	{
		m_alignmentStart = alignStart;
	}
	void SetAlignmentEnd(int alignEnd)
	{
		m_alignmentEnd = alignEnd;
	}
	...
	inline bool IsEnd(wxShape *nodeObject) const
	{
		return (m_to == nodeObject);
	}
